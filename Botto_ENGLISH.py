...
print('Write \'bot\' if you want to write a word for the bot to solve')
print('Write \'help\' if you want help with the Wordle of the day')
hvadaleik = input()
...
if hvadaleik == 'bot':
    ...
    targetWord = input('Write a word that is in possible_words.txt:')#random.choice(possible_final_char)
    ...
    print('We choose the word ',end = '')
    prentalitur(guessWord,svar)
    print(' out of ' + str(len(pool))+  ' possible guesses.')
    #print(svar)
    ...
    if svar == [2, 2, 2, 2, 2]:
      sum = sum + 1
        ...
        for j in range(5):
          ...
          print('We choose the word ',end = '')
          prentalitur(guessWord,svar)
          print(' out of ' + str(len(words_old))+  ' possible guesses.')
          if svar == [2,2,2,2,2]:
            sum = sum+2+j
            break
    print()
    if sum == 0:
        print('The bot could not solve for the word in 6 guesses or less')
    else:
        print('Solved with ' + str(sum) + ' guesses.')

elif hvadaleik == 'help':
    print()
    print('Help with today\'s Wordle!')
    print('Write the guess that you put in on the Wordle website after \'word:\' ')
    print('Write the color of each letter,' ,end='')
    print('\033[1;32m' +' 2 for green' + '\033[1;37m' +', ' ,end='')
    print('\033[1;33m' + '1 for yellow' + '\033[1;37m')
    print('and 0 for gray/' + '\033[1;31m'+'red.' +'\033[1;37m' +' after \'colors:\' ')
    print('\n'+ 'Example')
    print('word: ', end='')
    ...
    #Hermun með besta orði
    #
    print('\n'+'A good first guess is \'slate\' .')
    print('\n' + 'If you want to exit, don\'t write anything after \'word:\' and press Enter.')
    pool = possible_final_char
    sum = 0
    while(True):
        sum = sum + 1
        ...
        print('Possible word to guess are:')
        print(*pool)
        print()
        print('We choose the word ',end = '')
        ...
        if litir_in_int == [2,2,2,2,2]:
          print()
          print('Congratulations you won with ' + str(sum) + ' guesses!')
          break
else:
